...
const kadın = message.guild.roles.cache.find(r => r.id === '798562334099505200')
const kadın2 = message.guild.roles.cache.find(r => r.id === '798562334099505199')
const kadın3 = message.guild.roles.cache.find(r => r.id === '798562334092034077')
...
.setDescription(`
${member} Kullanıcı başarıyla ${kadın} olarak kayıt edildi
...
Yetkilinin toplam **${alldata}** kaydı ve toplam **${kadındata}** kadın kaydı bulunmaktadır.
Yetkili kullanıcıyı ${kadın} olarak kayıt etti.`)
